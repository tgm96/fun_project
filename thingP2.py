...
def run_game():
    ...
    heroName = raw_input("What is your name?: ")
    print("Hello " + heroName)
    time.sleep(0.5)
    print("You are fighting a mighty monster. It has 100 points of health\n")
    ...
    while True:
        ...
        print("-----------------\n")
        choice = raw_input("What move will you use? Punch, Slash, or Heal? 1/2/3: ")
        ...
        if opp_health < 35:
            moves.append("heal")
            moves.append("heal")
            monster_choice = moves[random.randint(0,4)]
